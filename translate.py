...
class get_result(object):
    def __init__(self,host):
        ...
        self.Secret = "NzkwMzAxMTE3MDAwNTVkM2I5OTc3N2Jk"
        # 接口APIKey（到控制台机器翻译服务页面获取）
        self.APIKey= "add2751e3fa04774757e5058c5c06993"
...
async def create_item(item: Item):
    ...
    gClass.Text = item.text
    return gClass.call_url()["data"]["result"]["trans_result"]["dst"]

if __name__ == '__main__':
    ##示例:  host="itrans.xfyun.cn"域名形式
    uvicorn.run("translate:app",host="0.0.0.0",port=5000,reload=True)
